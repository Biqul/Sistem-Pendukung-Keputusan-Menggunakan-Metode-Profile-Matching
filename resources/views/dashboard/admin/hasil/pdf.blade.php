                            ...
                            @if($ranking->alternatif_id == $alternatif->id)
                                <td>{{ $alternatif->name }}</td>
                                    ...
                                    @if($alternatif->hasil_id == 5)
                                        <!-- Keterangan -->
                                        <td class="text-success" style='text-align:center; vertical-align:middle; font-weight: bold; color: green;'>Lulus</td>
                                    @else
                                        <!-- Keterangan -->
                                        <td style='text-align:center; vertical-align:middle; font-weight: bold; color: red;'>Gagal</td>
                                    @endif
                            @endif
                        @endforeach
                        </tr>
