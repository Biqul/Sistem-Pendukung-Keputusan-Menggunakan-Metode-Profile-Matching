...
<div class="card shadow mb-4 mt-3">
  ...
  <div class="card-body">
    <form action="{{ url('pembukaans') }}" method="post">
    @csrf
      <div class="mb-3">
      ...
      <div class="mb-3">
        <div class="row justify-content-between text-left">
          <div class="form-group col-sm-6 flex-column d-flex">
            ...
            <input type="text" class="form-control @error('periode') is-invalid @enderror" id="periode" name="periode" placeholder="Tahun/Tahun" required value="{{ old('periode') }}">
            @error('periode')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
        ...
        <button type="submit" class="btn btn-success mb-2" style="float: right; border-radius: 20px;"><i class="fa-solid fa-floppy-disk fa-fw"></i> Buat Seleksi</button>
